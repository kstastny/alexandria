...
var CONFIG = {
    ...
    indexHtmlTemplate: './src/Alexandria.Client/public/index.html',
    fsharpEntry: './src/Alexandria.Client/.fable-build/App.js',
    cssEntry: './src/Alexandria.Client/styles/styles.scss',
    outputDir: './publish/app/public',
    assetsDir: './src/Alexandria.Client/public',
    devServerPort: 8080,
